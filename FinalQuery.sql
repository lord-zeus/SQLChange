...
FROM (SELECT * from jobs where Jobs.publish_status = 1 and Jobs.deleted IS NULL) Jobs
...
WHERE ((JobCategories.name LIKE '%Marie%'
OR JobTypes.name LIKE '%Marie%'
OR Jobs.name LIKE '%Marie%'
OR Jobs.description LIKE '%Marie%'
OR Jobs.detail LIKE '%Marie%'

OR Jobs.business_skill LIKE '%Marie%'
OR Jobs.knowledge LIKE '%Marie%'
OR Jobs.location LIKE '%Marie%'
OR Jobs.activity LIKE '%Marie%'
OR Jobs.salary_statistic_group LIKE '%Marie%'
OR Jobs.salary_range_remarks LIKE '%Marie%'
OR Jobs.restriction LIKE '%Marie%'
OR Jobs.remarks LIKE '%Marie%'
OR Personalities.name LIKE '%Marie%'
OR PracticalSkills.name LIKE '%Marie%'
OR BasicAbilities.name LIKE '%Marie%'
OR Tools.name LIKE '%Marie%'
OR CareerPaths.name LIKE '%Marie%'
OR RecQualifications.name LIKE '%Marie%'
OR ReqQualifications.name LIKE '%Marie%'))
GROUP BY Jobs.id
